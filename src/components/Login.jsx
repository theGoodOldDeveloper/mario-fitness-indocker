  ...
  useEffect(() => {
    try {
      ...
      async function fetchData() {
        ...
        console.log(
          "❤❤❤ ~ file: Login.jsx:26 ~ fetchData ~ response.data:",
          response.data
        );
        setMembers((members = response.data));

        console.log(
          "❤❤❤❤❤ ~ file: Login.jsx:26 ~ fetchData ~ members:",
          members
        );
      }
    } catch (error) {
  ...
  return (
    <React.Fragment>
      <div className="logginRegister text-center">
        ...
        <h6 className="mb-4 me-4 text-end fixed-bottom">
          <span>
            <img className="rounded-circle" src="portrait.jpg" width="25" />
          </span>
          ©2023 by photovegh with react
        </h6>
      </div>
    </React.Fragment>
  );
