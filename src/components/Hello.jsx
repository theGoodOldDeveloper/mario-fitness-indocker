...
const Hello = (props) => {
  ...
  typeBooking = allTrainingBooking.training.map(
    (booking) => booking.trainingID
  );
  typeBookingDate = allTrainingBooking.training.map(
    (booking) => booking.trainingDATE
  );
  ...
  function bookingNumber() {
    weekTypeBookindDate = actualTypeBookindDateWEEK(
      trainingType,
      actualMonday,
      weekNumber
    );
  ...
  if (!localStorage.getItem("isLogin")) {
    ...
    return (
      <div className="container text-center">
        ...
        <h3 className="card bg-light text-success mb-4 p-2">
          Légy üdvözölve {localStorage.getItem("memberName")}!!! 😉
        </h3>
        {/* //NOTE - HÉTFŐ */}
        <div className="card bg-light mb-2 p-2">
          ...
          <div className="d-flex justify-content-around">
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[0]}
              ptrainingType={trainingType[0]}
              pweekNumber={weekNumber}
              pWeekDayNumber={0}
              pweekTypeBookindDate={weekTypeBookindDate[0]}
            />
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[1]}
              ptrainingType={trainingType[1]}
              pweekNumber={weekNumber}
              pWeekDayNumber={0}
              pweekTypeBookindDate={weekTypeBookindDate[1]}
            />
          </div>
        </div>
        ...
        <div className="card bg-light mb-2 p-2">
          ...
          <div className="d-flex justify-content-around">
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[2]}
              ptrainingType={trainingType[2]}
              pweekNumber={weekNumber}
              pWeekDayNumber={1}
              pweekTypeBookindDate={weekTypeBookindDate[2]}
            />
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[3]}
              ptrainingType={trainingType[3]}
              pweekNumber={weekNumber}
              pWeekDayNumber={1}
              pweekTypeBookindDate={weekTypeBookindDate[3]}
            />
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[4]}
              ptrainingType={trainingType[4]}
              pweekNumber={weekNumber}
              pWeekDayNumber={1}
              pweekTypeBookindDate={weekTypeBookindDate[4]}
            />
          </div>
        </div>
        ...
        <div className="card bg-light mb-2 p-2">
          ...
          <div className="d-flex justify-content-around">
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[5]}
              ptrainingType={trainingType[5]}
              pweekNumber={weekNumber}
              pWeekDayNumber={2}
              pweekTypeBookindDate={weekTypeBookindDate[5]}
            />
          </div>
        </div>
        ...
        <div className="card bg-light mb-2 p-2">
          ...
          <div className="d-flex justify-content-around">
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[6]}
              ptrainingType={trainingType[6]}
              pweekNumber={weekNumber}
              pWeekDayNumber={3}
              pweekTypeBookindDate={weekTypeBookindDate[6]}
            />
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[7]}
              ptrainingType={trainingType[7]}
              pweekNumber={weekNumber}
              pWeekDayNumber={3}
              pweekTypeBookindDate={weekTypeBookindDate[7]}
            />
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[8]}
              ptrainingType={trainingType[8]}
              pweekNumber={weekNumber}
              pWeekDayNumber={3}
              pweekTypeBookindDate={weekTypeBookindDate[8]}
            />
          </div>
        </div>
        ...
        <div className="card bg-light mb-2 p-2">
          ...
          <div className="d-flex justify-content-around">
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[9]}
              ptrainingType={trainingType[9]}
              pweekNumber={weekNumber}
              pWeekDayNumber={6}
              pweekTypeBookindDate={weekTypeBookindDate[9]}
            />
            <TrainingBTN
              ppersonReservationNumber={personReservationNumber[10]}
              ptrainingType={trainingType[10]}
              pweekNumber={weekNumber}
              pWeekDayNumber={6}
              pweekTypeBookindDate={weekTypeBookindDate[10]}
            />
          </div>
        </div>
